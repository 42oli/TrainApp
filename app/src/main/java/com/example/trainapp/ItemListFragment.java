...
import com.example.trainapp.databinding.FragmentItemListBinding;
import com.example.trainapp.databinding.ItemListContentBinding;
...
public class ItemListFragment extends Fragment {
    ...
    public static class SimpleItemRecyclerViewAdapter
        ...
        SimpleItemRecyclerViewAdapter(List<Person> items,
                                      View itemDetailFragmentContainer) {
            mValues = items;
